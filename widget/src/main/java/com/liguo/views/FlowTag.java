...
public class FlowTag extends ViewGroup {
    ...
    private static final String TAG = FlowTag.class.getSimpleName();
    ...
    public FlowTag(Context context, AttributeSet attrs, int defStyleAttr) {
...
//            Log.e(TAG,mlp.leftMargin+";;"+mlp.topMargin+";;"+mlp.rightMargin+";;"+mlp.bottomMargin+"------------------");
                ...
                public void onClick(View v) {
                    if (mTagCheckMode == FLOW_TAG_CHECKED_NONE) {
                        if (mOnTagClickListener != null) {
                            mOnTagClickListener.onItemClick(FlowTag.this, childView, j);
                        }
                        ...
                        if (mCheckedTagArray.get(j)) {
                            ...
                            if (mOnTagSelectListener != null) {
                                mOnTagSelectListener.onItemSelect(FlowTag.this, new ArrayList<Integer>());
                            }
                            return;
                        }
                        ...
                        if (mOnTagSelectListener != null) {
                            mOnTagSelectListener.onItemSelect(FlowTag.this, Arrays.asList(j));
                        }
                    } else if (mTagCheckMode == FLOW_TAG_CHECKED_MULTI) {
                        if (mCheckedTagArray.get(j)) {
                            mCheckedTagArray.put(j, false);
                        ...
                        if (mOnTagSelectListener != null) {
                            ...
                            mOnTagSelectListener.onItemSelect(FlowTag.this, list);
                        }
                    }
                }
            });
    ...
    public interface OnTagClickListener {
        void onItemClick(FlowTag parent, View view, int position);
    }

    public interface OnTagSelectListener {
        void onItemSelect(FlowTag parent, List<Integer> selectedList);
    }
}
