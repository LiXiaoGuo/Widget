    ...
    public static String createFolder(String folderPath) {
        try {
            ...
            if (!myFilePath.exists()) {
                myFilePath.mkdirs();
//                Log.e("123123123123","1111111111111111111"+folderPath);
            }else{
//                Log.e("123123123123","2222222222222222222"+folderPath);
            }
        } catch (Exception e) {
            message = "创建目录操作出错";
//            Log.e("123123123123",message+";"+folderPath);
        }
//        Log.e("123123123123","---------------;"+folderPath);
        return folderPath;
    }
